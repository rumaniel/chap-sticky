...
| # | 항목 | 내용 | 공수 | 리스크 | 상태 |
|---|---|---|---|---|---|
| R1 | 거실 벽 소품 | 칠판(낙서)·냉장고(포스트잇) 수준의 이야기 소품 없음 — 액자·스위치 등 1~2개 추가 | ~30분 | 저 | 제안 |
| R2 | 문어찐득 실루엣 | 다리 가늘어 세균처럼 보임 — 두께·곡률 업, 돔 확대. 물리(stickyPoints) 불변 | ~40분 | 저 | 제안 |
| R3 | 거실 별 스팟 존재감 | 반투명 라벤더가 벽지에 묻힘 — 알파/테두리 링 강화 | ~10분 | 저 | 제안 |
...
| 거실 벽 (기본, 그립 1.0) | 줄무늬+도트 벽지, 별 스팟 2 | 🔶 R1·R3 — 소품 없음, 스팟 묻힘 |
