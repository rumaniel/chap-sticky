...
| R15 | 퍼펙트 밴드 폭이 맵마다 다름 | `PERFECT_BAND` 는 충격비 `r` 공간 정의인데 `r` 의 세기 민감도가 맵마다 달라, 세기로 환산하면 칠판 8.1% / 거실 7.7% / 냉장고 **28.0%** 폭이 된다. 냉장고 퍼펙트율만 62% 인 이유. 밴드를 맵별로 정규화할지 판단 필요 | ~40분 | 중 | 제안 |
